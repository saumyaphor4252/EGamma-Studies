...
# with command line options: Phase2 -s HLT:@relvalRun4 --processName=HLTX --conditions auto:phase2_realistic_T33 --geometry ExtendedRun4D110 --era Phase2C17I13M9 --customise SLHCUpgradeSimulations/Configuration/aging.customise_aging_1000,Configuration/DataProcessing/Utils.addMonitoring --eventcontent FEVTDEBUGHLT --filein=file:/eos/cms/store/relval/CMSSW_15_1_0_pre1/RelValZpToEE_m6000_14TeV/GEN-SIM-DIGI-RAW/141X_mcRun4_realistic_v3_STD_RegeneratedGS_Run4D110_noPU-v1/2580000/1f0ae4ae-6a54-4544-9b86-09bbb1022fcb.root --inputCommands=keep *,drop *_hlt*_*_HLT,drop triggerTriggerFilterObjectWithRefs_l1t*_*_HLT -n 10 --nThreads 1
