...
# with command line options: stepMINI -s PAT --conditions 150X_dataRun3_Prompt_v1 --datatier MINIAOD -n 100 --eventcontent MINIAOD --python_filename makeMini_cfg.py --geometry DB:Extended --era Run3_2025 --filein file:hltOutput_RECO.root --fileout file:stepMINI.root --hltProcess MYHLT
