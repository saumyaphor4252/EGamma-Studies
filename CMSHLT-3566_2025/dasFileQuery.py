...
#        print("Error:", result.stderr)
    ...
    dir = "/eos/cms/store/data/Run2025C/EGamma3/RAW-RECO/ZElectron-PromptReco-v1/000/"
    ...
    with open('List_EGamma3_cff.py', 'w') as file:
        file.write(cff_content)

dasFileQuery("/EGamma3/Run2025C-ZElectron-PromptReco-v1/RAW-RECO")
# dasgoclient --query "file dataset=/EGamma3/Run2024G-ZElectron-PromptReco-v1/RAW-RECO | grep file.name,file.nevents" --limit 1425 | awk '{sum += $2} END {print sum}'
