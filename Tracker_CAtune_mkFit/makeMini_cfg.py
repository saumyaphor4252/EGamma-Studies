...
# with command line options: stepMINI -s PAT --conditions 140X_dataRun3_Prompt_v3 --datatier MINIAOD -n 200 --eventcontent MINIAOD --python_filename makeMini_cfg.py --geometry DB:Extended --era Run3_2024 --filein file:hltOutput_RECO.root --fileout file:stepMINI.root --hltProcess MYHLT
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:hltOutput_RECO.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('stepMINI nevts:200'),
