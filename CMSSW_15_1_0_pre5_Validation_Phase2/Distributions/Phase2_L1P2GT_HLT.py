...
process.source = cms.Source("PoolSource",
    ...
    fileNames = cms.untracked.vstring('file:/eos/cms/store/relval/CMSSW_15_1_0_pre5/RelValZpToEE_m6000_14TeV/GEN-SIM-DIGI-RAW/PU_150X_mcRun4_realistic_v1_STD_Run4D110_PU-v1/2580000/60162ee0-7e0e-427b-b358-847a52097dfe.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Phase2 nevts:5'),
...
# Automatic addition of the customisation function from HLTrigger.Configuration.customizeHLTforEGamma
from HLTrigger.Configuration.customizeHLTforEGamma import customiseEGammaMenuDev 

#call to customisation function customiseEGammaMenuDev imported from HLTrigger.Configuration.customizeHLTforEGamma
