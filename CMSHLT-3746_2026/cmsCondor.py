...
#dirName = "/eos/cms/store/group/phys_egamma/ssaumya/CMSHLT-3719/HLTstep_RECO_RootFiles_Reference/"
...
process.hltOutputMinimal.fileName = "stepHLT.root"
...
for i in range(0, nJobs):
    ...
    tmp_job.write("cp stepHLT.root %s/stepHLT_%s.root\n"%(remoteDir, str(i)))
    tmp_job.write("rm stepHLT.root\n")
    tmp_job.close()
