...
#        print("Error:", result.stderr)
    ...
    dir = "/eos/cms/store/data/Run2026B/EGamma4/RAW-RECO/ZElectron-PromptReco-v1/000/"
...
dasFileQuery("/EGamma4/Run2026B-ZElectron-PromptReco-v1/RAW-RECO")
# dasgoclient --query "file dataset=/EGamma4/Run2024G-ZElectron-PromptReco-v1/RAW-RECO | grep file.name,file.nevents" --limit 1425 | awk '{sum += $2} END {print sum}'
