...
# with command line options: stepMINI -s PAT --conditions 160X_dataRun3_Prompt_v1 --datatier MINIAOD -n 100 --eventcontent MINIAOD --python_filename makeMini_cfg.py --geometry DB:Extended --era Run3_2026 --filein file:hltOutput_RECO_Reference.root --fileout file:stepMINI.root --hltProcess MYHLT
import FWCore.ParameterSet.Config as cms

from Configuration.Eras.Era_Run3_2026_cff import Run3_2026

process = cms.Process('PAT',Run3_2026)
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:hltOutput_RECO_Reference.root'),
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('stepMINI nevts:100'),
...
# Schedule definition
process.schedule = cms.Schedule(process.Flag_BadChargedCandidateFilter,process.Flag_BadChargedCandidateSummer16Filter,process.Flag_BadPFMuonDzFilter,process.Flag_BadPFMuonFilter,process.Flag_BadPFMuonSummer16Filter,process.Flag_CSCTightHalo2015Filter,process.Flag_CSCTightHaloFilter,process.Flag_CSCTightHaloTrkMuUnvetoFilter,process.Flag_EcalDeadCellBoundaryEnergyFilter,process.Flag_EcalDeadCellTriggerPrimitiveFilter,process.Flag_HBHENoiseFilter,process.Flag_HBHENoiseIsoFilter,process.Flag_HcalStripHaloFilter,process.Flag_chargedHadronTrackResolutionFilter,process.Flag_ecalBadCalibFilter,process.Flag_ecalLaserCorrFilter,process.Flag_eeBadScFilter,process.Flag_globalSuperTightHalo2016Filter,process.Flag_globalTightHalo2016Filter,process.Flag_goodVertices,process.Flag_hcalLaserEventFilter,process.Flag_hfNoisyHitsFilter,process.Flag_muonBadTrackFilter,process.Flag_trackingFailureFilter,process.Flag_trkPOGFilters,process.Flag_trkPOG_logErrorTooManyClusters,process.Flag_trkPOG_manystripclus53X,process.Flag_trkPOG_toomanystripclus53X,process.endjob_step,process.MINIAODoutput_step)
