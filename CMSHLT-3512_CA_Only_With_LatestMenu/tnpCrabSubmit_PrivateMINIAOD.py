...
#
submitVersion = "2025-05-06" # YYYY-MM-DD
doL1matching  = False
isAOD = False

defaultArgs   = ['doEleID=False','doPhoID=False','doTrigger=True']
mainOutputDir = '/store/group/phys_egamma/ssaumya/CATuning_mkFit/OnlyCA_6thMay2025/TnPTuples/%s' % (submitVersion)
...
config.Data.userInputFiles             = ['root://eosuser.cern.ch//eos/cms/store/group/phys_egamma/ssaumya/CATuning_mkFit/OnlyCA_6thMay2025/PATstep_MINIAOD_RootFiles_Target/stepPAT_MINIAOD_0.root']
...
path = "/eos/cms/store/group/phys_egamma/ssaumya/CATuning_mkFit/OnlyCA_6thMay2025/TnPTuples/"
...
# Input
dirName = "/eos/cms/store/group/phys_egamma/ssaumya/CATuning_mkFit/OnlyCA_6thMay2025/PATstep_MINIAOD_RootFiles_Target/"
...
submitWrapper('Target', fileList, eraData)
