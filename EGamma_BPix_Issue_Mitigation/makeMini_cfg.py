...
# with command line options: stepMINI -s PAT --conditions 140X_dataRun3_Prompt_v3 --datatier MINIAOD -n 200 --eventcontent MINIAOD --python_filename makeMini_cfg_LocalCheck.py --geometry DB:Extended --era Run3_2024 --filein file:stepHLT.root --fileout file:stepMINI.root --hltProcess MYHLT
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:stepHLT.root'),
