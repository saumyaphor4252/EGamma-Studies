...
# Modify GT parameters for spike killer settings
...
#dirName = "/eos/cms/store/group/phys_egamma/ssaumya/DeepDive/HLTstep_RECO_RootFiles/"
...
# Output definition
# For HLT step
process.RECOSIMoutput.fileName = "stepHLT_RECO.root"
# For PAT step
